...
dag = DAG(dag_id='dag_tcc_bronze_webscraping_inep',
...
bronze_webscraping_inep = SparkSubmitOperator(
                          task_id='load_bronze_webscraping_inep',
                          conn_id='spark_local',
                          ...
                          application='/usr/local/airflow/dags/tcc/bronze/inep/bronze_inep_webscraping.py',
                          dag=dag
                      )
...
start_dag >> bronze_webscraping_inep >> dag_finish