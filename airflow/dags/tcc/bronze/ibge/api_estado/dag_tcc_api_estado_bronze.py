...
dag = DAG(dag_id='dag_tcc_bronze_api_ibge_estado',
...
bronze_api_ibge_estado = SparkSubmitOperator(
                          task_id='load_bronze_api_ibge_estado',
                          conn_id='spark_local',
                          ...
                          application='/usr/local/airflow/dags/tcc/bronze/ibge/api_estado/bronze_ibge_api_estado.py',
                          dag=dag
                      )
...
start_dag >> bronze_api_ibge_estado >> dag_finish