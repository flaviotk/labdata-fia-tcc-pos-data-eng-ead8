...
dag = DAG(dag_id='dag_tcc_silver_dado_geografico_estado',
...
silver_dado_geografico_estado = SparkSubmitOperator(
                          task_id='load_silver_dado_geografico_estado',
                          conn_id='spark_local',
                          ...
                          application='/usr/local/airflow/dags/tcc/silver/dado_geografico/estado/silver_dado_geografico_estado.py',
                          dag=dag
                      )
...
start_dag >> silver_dado_geografico_estado >> dag_finish